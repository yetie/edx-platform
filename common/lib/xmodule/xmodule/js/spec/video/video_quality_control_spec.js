        ...
        describe('constructor, YouTube mode', function () {
            beforeEach(function () {
                ...
                player.getAvailableQualityLevels = function() {
                    return ['highres', 'hd1080', 'hd720', 'large', 'medium',
                            'small'];
                }
                player.getPlaybackQuality = function() {
            ...
            it('calls fetchAvailableQualities only once', function () {
                spyOn(player, 'getAvailableQualityLevels').andCallThrough();
            ...
            it('shows the quality control on play if HD is available',
               function () {
                player.getAvailableQualityLevels = jasmine
                    .createSpy('getAvailableQualityLevels')
                    .andReturn(['highres', 'hd1080', 'hd720', 'large', 'medium',
                                'small']);
            ...
            it('switch to HD if it is available', function () {
                player.getAvailableQualityLevels = jasmine
                    ...
                    .andReturn(['highres', 'hd1080', 'hd720', 'large', 'medium',
                                'small']);
                spyOn(player, 'setPlaybackQuality').andCallThrough();
